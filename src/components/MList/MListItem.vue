...
import { ListInjectionKey, type ListPropsInjection, type ListValue } from '../../composables/list'
...
const styleClass = computed(() => [
  injectionData.size,
  { disabled: injectionData.disabled, select: props.selected, group: props.isGroup },
  colorClass.value
])
const listClick = () => {
...
<template>
  <li class="m-list-item" :class="styleClass" :style="[colorStyle]" @click="listClick">
    <slot name="default">
